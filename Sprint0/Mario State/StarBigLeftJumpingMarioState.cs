...
namespace Sprint0
{
    internal class StarBigLeftJumpingMarioState : AbstractMarioState
    {
        private int jumpingPower = ConstantNumber.MARIO_JUMPING_POWER;

        public StarBigLeftJumpingMarioState(Mario mario) : base(mario)
        {
        ...
        {
            return new Rectangle((int)mario.Position.X + ConstantNumber.STAR_MARIO_POSITION_X_ADJUST, (int)mario.Position.Y, ConstantNumber.BIG_JUMPING_WALKING_WIDTH, ConstantNumber.BIG_HEIGHT);
        }
